...
import net.zypr.api.enums.UniformResourceIdentifierType;
import net.zypr.api.exceptions.APIProtocolException;

import org.json.simple.JSONObject;

public class UniformResourceIdentifierVO
  extends GenericVO
{
  private UniformResourceIdentifierType _type;
  private String _title;
  private String _value;

  public UniformResourceIdentifierVO()
  {
    super();
  }

  public UniformResourceIdentifierVO(UniformResourceIdentifierType type, String title, String value)
  {
    super();
    _type = type;
    _title = title;
  ...
  public UniformResourceIdentifierVO(JSONObject jsonObject)
    throws APIProtocolException
  {
    try
      {
        String type = (String) jsonObject.get("type");
        UniformResourceIdentifierType[] availableType = UniformResourceIdentifierType.values();
  ...
  public void setType(UniformResourceIdentifierType type)
  {
    UniformResourceIdentifierType oldType = _type;
    this._type = type;
    propertyChangeSupport.firePropertyChange("Type", oldType, type);
  }

  public UniformResourceIdentifierType getType()
  {
    return (_type);
  }
  ...
  @Override
  public UniformResourceIdentifierVO clone()
    throws CloneNotSupportedException
  {
    return ((UniformResourceIdentifierVO) super.clone());
  }
}
