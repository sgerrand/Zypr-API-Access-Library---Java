...
import net.zypr.api.enums.PhoneNumberType;
  ...
  extends GenericVO
{
  ...
  public PhoneNumberVO(PhoneNumberType type, String title, String value)
  {
    super();
    _type = type;
    _title = title;
  ...
  public PhoneNumberVO(JSONObject jsonObject)
    throws APIProtocolException
  {
    try
      {
        String type = (String) jsonObject.get("type");
        PhoneNumberType[] availableType = PhoneNumberType.values();
  ...
  @Override
  public PhoneNumberVO clone()
    throws CloneNotSupportedException
  {
    return ((PhoneNumberVO) super.clone());
  }
}
